...
public class WaterfallApp extends AppCompatActivity {
    public static final String EXTRA_MODE = "com.example.spectrogrammer34.MODE";
...
//                        switch (parent.getId()) {
//                            case R.id.x_axis:
//                                mWaterfallView.setLogX(position == 0);
//                                break;
//                            case R.id.y_axis:
//                                mWaterfallView.setLogY(position == 0);
//                                break;
//                        }
...

        {
            ...
            AdapterView.OnItemSelectedListener ItemSelectedListener = new AdapterView.OnItemSelectedListener() {
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    if (parent.getId() == R.id.time_scale_type) {
        ...
        View.OnClickListener CheckBoxListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    mWaterfallView.setShowDebugInfo(checked);
                }
                if(view.getId() == R.id.pauseWhenWaterfallReachesBottom)
                {
                    mPauseWhenWaterfallReachesBottom = checked;
                }
            }
        };
