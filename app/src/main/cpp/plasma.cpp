...
//    static {
//       System.loadLibrary("spectrogrammer34");
//    }
//
...
extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Spectrogram_SetProcessorFFT(JNIEnv * env, jclass obj, int length)
{
    auto *pFFT = new myFFT();
...
extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Spectrogram_SetProcessorGoertzel(JNIEnv * env, jclass obj, int length)
{
...
extern "C" JNIEXPORT jint JNICALL Java_com_example_spectrogrammer34_Spectrogram_GetFftLength(JNIEnv * env, jclass obj)
{
...
extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Spectrogram_SetBarsHeight(JNIEnv * env, jclass obj, jint  barsHeight_)
{
    context.barsHeight = barsHeight_;
    context.waterFallRaw = barsHeight_;
}

extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Spectrogram_SetOverlap(JNIEnv * env, jclass obj, jfloat timeOverlap_)
{
...
extern "C" JNIEXPORT jfloat JNICALL Java_com_example_spectrogrammer34_Spectrogram_GetOverlap(JNIEnv * env, jclass obj)
{
    return context.fractionOverlap;
}

extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Spectrogram_SetDecay(JNIEnv * env, jclass obj, jfloat decay_)
{
    context.decay = decay_;
}

extern "C" JNIEXPORT jfloat JNICALL Java_com_example_spectrogrammer34_Spectrogram_GetDecay(JNIEnv * env, jclass obj)
{
    return context.decay;
}

extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Spectrogram_SetVolume(JNIEnv * env, jclass obj, jfloat volume_)
{
    context.volume=volume_;
}
extern "C" JNIEXPORT jfloat JNICALL Java_com_example_spectrogrammer34_Spectrogram_GetVolume(JNIEnv * env, jclass obj)
{
    return context.volume;
}

extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Spectrogram_SetAverageCount(JNIEnv * env, jclass obj, jint c)
{
    bufferAverage.setAverageCount(c);
}
extern "C" JNIEXPORT jint JNICALL Java_com_example_spectrogrammer34_Spectrogram_GetAverageCount(JNIEnv * env, jclass obj)
{
    return bufferAverage.getAverageCount();
}

extern "C" JNIEXPORT float JNICALL Java_com_example_spectrogrammer34_Spectrogram_FreqToX(JNIEnv * env, jclass obj, double freq)
{
    return pScale->FreqToX(freq);
}

extern "C" JNIEXPORT float JNICALL Java_com_example_spectrogrammer34_Spectrogram_XToFreq(JNIEnv * env, jclass obj, double x)
{
    return pScale->XtoFreq(x);
}

extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Spectrogram_HoldData(JNIEnv * env, jclass obj)
{
    pthread_mutex_lock(&context.scaleLock);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Spectrogram_ClearHeldData(JNIEnv * env, jclass obj)
{
    pthread_mutex_lock(&context.scaleLock);
    free(m_pHoldedData);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Spectrogram_ResetScanline(JNIEnv * env, jclass obj)
{
    pthread_mutex_lock(&context.scaleLock);
...
extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Spectrogram_SetScaler(JNIEnv * env, jclass obj, int screenWidth, double minFreq, double maxFreq, jboolean bLogX, jboolean bLogY)
{
    pthread_mutex_lock(&context.scaleLock);
...
extern "C" JNIEXPORT int JNICALL Java_com_example_spectrogrammer34_Spectrogram_GetIterationsPerChunk(JNIEnv * env, jclass obj)
{
    return context.perfCounters.iterationsPerChunk;
}

extern "C" JNIEXPORT double JNICALL Java_com_example_spectrogrammer34_Spectrogram_GetMillisecondsPerChunk(JNIEnv * env, jclass obj)
{
    return context.millisecondsProcessingChunk;
}

extern "C" JNIEXPORT jstring JNICALL Java_com_example_spectrogrammer34_Spectrogram_GetDebugInfo(JNIEnv * env, jclass obj)
{
    char sout[1024];
    char *pOut = sout;
...
extern "C" JNIEXPORT int JNICALL Java_com_example_spectrogrammer34_Spectrogram_GetDroppedFrames(JNIEnv * env, jclass obj)
{
...
extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Spectrogram_Disconnect(JNIEnv * env, jclass obj) {
...
extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Spectrogram_Init(JNIEnv * env, jclass  obj, jobject bitmap)
{
    pthread_mutex_lock(&context.scaleLock);
...
extern "C" JNIEXPORT int JNICALL Java_com_example_spectrogrammer34_Spectrogram_Lock(JNIEnv * env, jclass  obj, jobject bitmap)
{
    pthread_mutex_lock(&context.scaleLock);
//    LOGE("Begin Lock");
...
extern "C" JNIEXPORT void JNICALL Java_com_example_spectrogrammer34_Spectrogram_Unlock(JNIEnv * env, jclass  obj, jobject bitmap)
{
//    LOGE("Begin Unlock");
    int ret;
    if ((ret = AndroidBitmap_getInfo(env, bitmap, &context.info)) < 0) {
